...
public class UploadMultipleModel : PageModel
{
    ...
    public UploadMultipleModel(ILogger<IndexModel> logger, IConfiguration configuration)
    {
    ...
    public IActionResult OnPostUpload()
    {
        ...
        {
            foreach (var thisFile in FileUploads)
            {
